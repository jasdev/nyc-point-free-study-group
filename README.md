...
Watchings will be held from 6:30–7:30pm Eastern time at Peloton’s office ([125 W 25th St., New York, NY 10001][2]). Upon arrival, send Jasdev a DM in the iOS Folks Slack (`@jasdev`) and he can badge you up.
...
We’ll start the viewing at \~6:30pm and then open a Hangout _afterwards_ (here’s the [latest link][4] and it’ll also be in the shared calendar) to work on and discuss exercises. So, feel free to hop in at 6:30pm + (that week’s episode length) + (a few minutes buffer). It’s also totally cool if you want to listen in on the conversation without participating.

## Schedule

| Date | Episode |
| ----------- | ------------- |
| 3/16/2020 | Episode #94 |
...
[4]:	https://meet.google.com/qmp-hden-jra
